...
class  Attendance:
    def __init__(self,root):
        ...
        img=Image.open(r"C:\Users\Meena Jhala\Desktop\major prject\college_images\download (3).jpeg")
        img = img.resize((900,200), Image.LANCZOS)
        ...
        img1=Image.open(r"C:\Users\Meena Jhala\Desktop\major prject\college_images\th (6).jpeg")
        img1 = img1.resize((600,200), Image.LANCZOS)
        ...
        # bg img
        img3=Image.open(r"C:\Users\Meena Jhala\Desktop\major prject\college_images\th (3).jpeg")
        ...
        left_inside_frame.place(x=0, y=135, width=680, height= 250)
        ...
        table_frame.place(x=5, y=5, width=550, height=300)
